...
private:
    ...
    static PairVector makePairs(const std::vector<int>& vec, 
    ...
    static void insertPend(std::vector<int>& main,
                          const std::vector<int>& pend,
                          const std::vector<int>& order);
    static void addStraggler(std::vector<int>& main,
                            int straggler, bool hasStraggler);
    
    // Deque helper functions
    static PairVector makePairsDeq(const std::deque<int>& deq,
                                   int& straggler, bool& hasStraggler);
    static void splitToMainAndPendDeq(const PairVector& pairs,
                                      std::deque<int>& main,
                                      std::deque<int>& pend);
    static void insertPendDeq(std::deque<int>& main,
                             const std::deque<int>& pend,
                             const std::vector<int>& order);
    static void addStragglerDeq(std::deque<int>& main,
                               int straggler, bool hasStraggler);
